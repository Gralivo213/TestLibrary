...
.iso-herb-panel.visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
              ...
              .iso-msg-box.visible { opacity: 1; transform: translateX(0); }
                ...
                .iso-nameplate {
                    position: absolute;
                    top: -22px;       /* Adjusted to sit flush on top of the bar */
                    left: 55px;       /* Tucked slightly behind the octagon (72px width) */
                    height: 24px;
                    background: #0f0f0f;
                    ...
                    display: flex;
                    align-items: center;
                    padding-left: 20px; /* Push text past the octagon overlap */
                    padding-right: 30px;
                    min-width: 100px;
                    white-space: nowrap;
                    z-index: 15;      /* Ensures it sits BEHIND the octagon */
                    clip-path: polygon(0 0, 92% 0, 100% 100%, 0% 100%); /* Slanted End */
                }
            `;
