...
.iso-herb-panel.visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
              ...
              .iso-msg-box.visible { opacity: 1; transform: translateX(0); }
                ...
                .iso-jade-plate {
                    ...
                    background: linear-gradient(to bottom, #4f7351, #385539, #2b422d);
                    border-top: 2px solid #73a175; border-bottom: 2px solid #1c2c1e;
                    border-radius: 4px; margin-left: 3.5vw; margin-bottom: 1.2vw;
                    padding: 0.6vw 1vw 0.6vw 4vw;
                    box-shadow: 0 4px 8px rgba(0,0,0,0.6), inset 0 0 10px rgba(0,0,0,0.3);
                    min-height: 5vw;
                }
                .iso-jade-emblem {
                    position: absolute; left: -3.5vw; top: 50%; transform: translateY(-50%);
                    width: 6.5vw; height: 6.5vw; z-index: 2;
                }
                .iso-jade-content { display: flex; flex-direction: column; gap: 0.1vw; }
                .iso-jade-line { font-size: 1.4vw; line-height: 1.2; text-shadow: 1px 1px 3px rgba(0,0,0,0.9); }
                .iso-jade-line .jade-label { color: #e5c06b; font-weight: normal; letter-spacing: 0.05em; }
                .iso-jade-line .jade-val { color: #ffffff; }
          ...
          // 3. Build Composite UI (Octagon + Stacked Bars Column)
            ...
            statPopup.innerHTML = `
                ...
                <div class="iso-stat-body" id="stat-info-body">
                    ...
                    <div class="iso-jade-plate">
                        <div class="iso-jade-emblem">${jadeEmblemSvg}</div>
                        <div class="iso-jade-content">
                    ...
                    <div class="iso-jade-plate">
                        ...
                        <div class="iso-jade-content">
                            ...
                            <div class="iso-jade-line"><span class="jade-label">Affiliation:</span> <span class="jade-val"></span></div>
