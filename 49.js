...
.iso-herb-panel.visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
        ...
        drawNPC(lx, ly, npcData) {
            ...
            if (nImg && nImg.naturalWidth > 0) {
                this.ctx.drawImage(nImg, -radius, -radius - thickness, radius * 2, radius * 2);
            }
            this.ctx.restore();
        ...
        drawPlayer() {
            ...
            this.ctx.translate(x, y + (CONFIG.TILE_HEIGHT * this.camera.zoom) / 2);
            this.ctx.scale(1, 0.5);
            this.ctx.beginPath(); this.ctx.arc(0, 0, radius, 0, Math.PI * 2);
            ...
            if (pImg && pImg.naturalWidth > 0) {
                this.ctx.drawImage(pImg, -radius, -radius - thickness, radius * 2, radius * 2);
            } else {
