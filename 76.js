        ...
        createUI() {
            ...
            style.textContent = `
                .iso-stamina-container {
                    position: fixed; top: -60px; left: -100px;
                    z-index: 100; transform: scale(0.42); transform-origin: top left;
                    pointer-events: auto;
                }
