...
.iso-herb-panel.visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
              ...
              .iso-msg-box.visible { opacity: 1; transform: translateX(0); }
                ...
                .iso-stat-info-text { font-size: 1.6vw; line-height: 1.35; margin-bottom: 0.2vw; }
                .iso-stat-info-text .label { color: #fbbf24; }

                .iso-stat-bio { margin-top: 2vw; font-size: 1.5vw; color: #e5e5e5; line-height: 1.4; }
          ...
          // 3. Build Composite UI (Octagon + Stacked Bars Column)
            ...
            statPopup.innerHTML = `
                ...
                <div class="iso-stat-body" id="stat-info-body">
                    <div class="iso-stat-info-text"><span class="label">Name:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Alias:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Lifespan:</span> / </div>
                    <div class="iso-stat-info-text"><span class="label">Gender:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Clan:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Affiliation:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Alignment:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Reputation:</span> </div>
                    <div class="iso-stat-info-text"><span class="label">Dao Vow:</span> </div>
