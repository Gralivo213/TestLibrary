...
<div class="iso-ui-text-layer">
        ...
        drawPlayer() {
            ...
            // Transparency for "Hide" mode            const modes = ['WalkUI.png', 'RunUI.png', 'SneakUI.png', 'HideUI.png'];
        ...
        render(timestamp) {
            ...
            // 3. Draw UI Overlays (Region borders on top of everything)            this.drawRegions(timestamp);
        } loop(timestamp) {
            if (!this.active) return;
