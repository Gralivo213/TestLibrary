...
.iso-stamina-container {
                    ...
                    pointer-events: auto; display: flex !important; flex-direction: row !important; opacity: 1 !important;
                    align-items: center; width: 1200px; font-family: 'Segoe UI', Roboto, sans-serif;
                }
                .iso-stamina-octagon-wrap {
                    position: relative; z-index: 20; flex-shrink: 0; width: 288px; height: 288px; margin-right: 20px;
                }
                .iso-stamina-octagon-border {
                ...
                .iso-stamina-octagon-bg {
                    width: 100%; height: 100%; padding: 4px;
                    background: linear-gradient(135deg, #34d399, #065f46, #064e3b);
                    clip-path: polygon(29.3% 0%, 70.7% 0%, 100% 29.3%, 100% 70.7%, 70.7% 100%, 29.3% 100%, 0% 70.7%, 0% 29.3%);
                }
                .iso-stamina-octagon-inner {
                    width: 100%; height: 100%; background: #000; position: relative; overflow: hidden; cursor: pointer;
                    clip-path: polygon(29.3% 0%, 70.7% 0%, 100% 29.3%, 100% 70.7%, 70.7% 100%, 29.3% 100%, 0% 70.7%, 0% 29.3%);
                }
                .iso-stamina-bar-container {
                    position: relative; z-index: 10; margin-left: -24px; flex-grow: 1; height: 128px; display: flex; align-items: center;
                }
                .iso-stamina-bar-wrap {
                    position: relative; width: 100%; height: 96px; filter: drop-shadow(0 10px 20px rgba(0,0,0,0.8));
                }
                .iso-stamina-bar-stroke {
                    position: absolute; inset: 0; background: #000; transform: scale(1.02) translateY(4px);
                    clip-path: polygon(0% 12%, 5% 2%, 15% 5%, 25% 0%, 40% 6%, 55% 1%, 70% 5%, 85% 0%, 98% 8%, 100% 25%, 97% 40%, 100% 55%, 98% 70%, 100% 85%, 95% 98%, 80% 94%, 65% 100%, 50% 95%, 35% 100%, 20% 96%, 10% 100%, 2% 90%, 0% 75%, 4% 50%, 0% 25%);
                }
                .iso-stamina-bar-fill-bg {
                    position: absolute; inset: 0; background: linear-gradient(to right, #171717, #1a1d26, #171717);
                    clip-path: polygon(0% 12%, 5% 2%, 15% 5%, 25% 0%, 40% 6%, 55% 1%, 70% 5%, 85% 0%, 98% 8%, 100% 25%, 97% 40%, 100% 55%, 98% 70%, 100% 85%, 95% 98%, 80% 94%, 65% 100%, 50% 95%, 35% 100%, 20% 96%, 10% 100%, 2% 90%, 0% 75%, 4% 50%, 0% 25%);
                    border-left: 4px solid rgba(217, 119, 6, 0.3);
                }
                .iso-stamina-bar-fill-inner {
                    position: absolute; inset: 6px; overflow: hidden; display: flex; align-items: center;
                    clip-path: polygon(0% 15%, 5% 5%, 15% 8%, 25% 3%, 40% 9%, 55% 4%, 70% 8%, 85% 3%, 97% 10%, 99% 25%, 96% 40%, 99% 55%, 97% 70%, 99% 85%, 94% 97%, 80% 92%, 65% 98%, 50% 93%, 35% 98%, 20% 94%, 10% 98%, 3% 88%, 1% 75%, 5% 50%, 1% 25%);
                }
                .iso-stamina-bar-progress {
                    height: 100%; width: 88%; background: linear-gradient(to right, #1e3a8a, #3b82f6, #22d3ee);
                    box-shadow: 0 0 30px #3b82f6;
                }
                .iso-stamina-bar-text-overlay {
                    position: absolute; inset: 0; display: flex; align-items: center; justify-content: space-between; padding: 0 64px; z-index: 20; pointer-events: none;
                }
                .iso-stamina-label {
                    color: #fbbf24; font-weight: bold; font-size: 36px; letter-spacing: 0.2em;
                }
                .iso-stamina-value-wrap {
                    display: flex; align-items: baseline; gap: 8px; color: #fff; font-weight: bold;
                }
                .iso-stamina-value-current { font-size: 48px; }
                .iso-stamina-value-max { font-size: 24px; color: #64748b; }
            ...
            staminaBar.innerHTML = `
                <div class="iso-stamina-octagon-wrap">
                    <div class="iso-stamina-octagon-border">
                        <div class="iso-stamina-octagon-bg">
                            <div class="iso-stamina-octagon-inner" id="stamina-img-box">
                ...
                <div class="iso-stamina-bar-container">
                    <div class="iso-stamina-bar-wrap">
                        <div class="iso-stamina-bar-stroke"></div>
                        <div class="iso-stamina-bar-fill-bg">
                            <div class="iso-stamina-bar-fill-inner">
                                <div class="iso-stamina-bar-progress"></div>
                            </div>
                            <div class="iso-stamina-bar-text-overlay">
                                <span class="iso-stamina-label">STAMINA</span>
                                <div class="iso-stamina-value-wrap">
                                    <span class="iso-stamina-value-current">88</span>
                                    <span class="iso-stamina-value-max">/ 100</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            // Pre-load UI assets immediately
            modes.forEach(m => AssetManager.load(`https://raw.githubusercontent.com/Gralivo213/TestLibrary/main/imh/${m}`));
