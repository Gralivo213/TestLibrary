...
.iso-herb-panel.visible { opacity: 1; transform: translateY(0); pointer-events: auto; }
              ...
              .iso-msg-box.visible { opacity: 1; transform: translateX(0); }
                ...
                .iso-nameplate {
                    position: absolute;
                    top: -15px;       /* Sit connected on top of the bar */
                    left: 62px;       /* Start after the Octagon center (connected look) */
                    height: 24px;
                    background: #0f0f0f;
                    ...
                    align-items: center;
                    padding-left: 15px;
                    padding-right: 30px; /* Space for slant */
                    min-width: 100px;
                    white-space: nowrap;
                    z-index: 15;      /* Behind Octagon */
                    clip-path: polygon(0 0, 90% 0, 100% 100%, 0% 100%); /* Slanted End */
...
<div class="iso-ui-text-layer">
        ...
        render(timestamp) {
            ...
            // 2. Draw UI Overlays (Regions on floor)
