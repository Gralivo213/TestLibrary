                        ...
                        if (this.ui.herbPanel) {
                            ...
                            if (data) {
                                ...
                                const setAction = (action) => {
                                    if (action === 'Harvest') {
                                        btnH.classList.add('active'); btnH.classList.remove('disabled');
                                        btnF.classList.remove('active'); btnF.classList.add('disabled');
                                    } else {
                                        btnF.classList.add('active'); btnF.classList.remove('disabled');
                                        btnH.classList.remove('active'); btnH.classList.add('disabled');
                                    }
                                ...
                                btnH.onclick = () => setAction('Harvest');
                                btnF.onclick = () => setAction('Feed');
                            }
